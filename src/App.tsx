...
function App() {
  ...
  const handleImage = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setOriginalFileName(file.name.split(".")[0]); // Store original name without extension
    ...
    <div className="site-container">
      ...
      <main>
        ...
        <p className="tip-text">
          💡 <strong>Tip:</strong> For a good balance between quality and size, a compression level of <strong>40–60%</strong> is recommended.
        </p>
